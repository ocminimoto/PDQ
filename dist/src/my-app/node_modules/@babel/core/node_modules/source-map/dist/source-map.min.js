!function (e, n) {
  ...
  return function (e) {
    ...
    function t(e) {
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, A = [], S = []; v < _;) if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
        for (r = new i(), r.generatedLine = l, s = v; s < _ && !this._charIsMappingSeparator(e, s); s++);if (t = e.slice(v, s), o = y[t]) v += t.length;else {
          for (o = []; v < s;) c.decode(e, v, C), u = C.value, v = C.rest, o.push(u);if (2 === o.length) throw new Error("Found a source, but no line and column");if (3 === o.length) throw new Error("Found a source and line, but no column");y[t] = o;
    ...
    function r(e, t, o, i, s, a) {
      ...
      if (0 === t.length) return -1;var s = r(-1, t.length, e, t, o, i || n.GREATEST_LOWER_BOUND);if (s < 0) return -1;for (; s - 1 >= 0 && 0 === o(t[s], t[s - 1], !0);) --s;return s;
    };
  }, function (e, n) {
    function r(e, n, r) {
      ...
      if (i < s) {
        var a = t(i, s),
            u = i - 1;r(e, a, s);for (var l = e[s], c = i; c < s; c++) n(e[c], l) <= 0 && (u += 1, r(e, u, c));r(e, u + 1, c);var g = u + 1;o(e, n, i, g - 1), o(e, n, g + 1, s);
      }
    ...
    function t(e, n, r, t, o) {
      ...
      function o(e, n) {
        ...
        }for (; g < e.generatedLine;) a.add(c()), g++;if (p < e.generatedColumn) {
      ...
      for (var n, r = 0, t = this.children.length; r < t; r++) n = this.children[r], n[u] ? n.walk(e) : "" !== n && e(n, { source: this.source, line: this.line, column: this.column, name: this.name });
    }, t.prototype.join = function (e) {
      var n,
          r,
          t = this.children.length;if (t > 0) {
        for (n = [], r = 0; r < t - 1; r++) n.push(this.children[r]), n.push(e);n.push(this.children[r]), this.children = n;
      }return this;
      ...
      for (var n = 0, r = this.children.length; n < r; n++) this.children[n][u] && this.children[n].walkSourceContents(e);for (var t = Object.keys(this.sourceContents), n = 0, r = t.length; n < r; n++) e(i.fromSetString(t[n]), this.sourceContents[t[n]]);
    }, t.prototype.toString = function () {
